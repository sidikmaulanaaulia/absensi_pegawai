...
class AbsensiController extends Controller
{
    ...
    public function exit(Request $request){
        ...
        $waktu_sekarang = Carbon::now();
        $mulai_absensi = Carbon::createFromTime(16, 0, 0); // Waktu mulai absensi pukul 07:00:00
        $berakhir_absensi = Carbon::createFromTime(17, 0, 0); // Waktu berakhir absensi pukul 08:00:00
        if ($waktu_sekarang->between($mulai_absensi, $berakhir_absensi)){
